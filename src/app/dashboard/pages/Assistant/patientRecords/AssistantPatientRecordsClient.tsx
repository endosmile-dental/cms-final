...
export default function AssistantPatientRecords({
  initialPatients,
}: {
  ...
  const displayPatients =
    initialPatients && initialPatients.length > 0 ? initialPatients : patients;
  ...
  return (
    <DashboardLayout>
      <div className="p-4 md:p-6 space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                View and manage patient information across the clinic
              </p>
            </div>
          </div>
        ...
        {/* Patient List Table - NO Detail View */}
        <Card className="bg-card border-border shadow-sm">
                ...
                },
                {
                  ...
                  render: (value: unknown) => {
                    ...
                    if (typeof value === "string") {
                      ...
                      typeof (value as Record<string, unknown>).contactNumber === "string"
                    ) {
                      contactValue = (value as Record<string, unknown>).contactNumber as string;
                    }
