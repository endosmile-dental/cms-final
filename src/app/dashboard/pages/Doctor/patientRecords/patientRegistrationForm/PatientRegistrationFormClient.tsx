                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <select
                            {...field}
                            className="w-full p-3 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 bg-background"
                          >
        ...
        >
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap gap-2 p-3 bg-green-50/50 rounded-lg">
